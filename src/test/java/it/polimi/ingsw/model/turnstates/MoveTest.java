...
class MoveTest {
    ...
    void setupWithAllWorkerAllowed() {
        ...
        assertFalse(acTargetCell.getAllValues().get(0).getPosition(1,0));
        assertFalse(acTargetCell.getAllValues().get(0).getPosition(0,1));
        assertFalse(acTargetCell.getAllValues().get(0).getPosition(2,2));
        assertTrue(acTargetCell.getAllValues().get(0).getPosition(0,0));
        assertTrue(acTargetCell.getAllValues().get(0).getPosition(2,0));
        assertTrue(acTargetCell.getAllValues().get(0).getPosition(2,1));
        assertTrue(acTargetCell.getAllValues().get(0).getPosition(0,2));
        assertTrue(acTargetCell.getAllValues().get(0).getPosition(1,2));

        //mockWorker 2 movements
        assertFalse(acTargetCell.getAllValues().get(1).getPosition(4,4));
        assertFalse(acTargetCell.getAllValues().get(1).getPosition(3,3));
        assertFalse(acTargetCell.getAllValues().get(1).getPosition(0,3));
        assertFalse(acTargetCell.getAllValues().get(1).getPosition(2,2));
        assertTrue(acTargetCell.getAllValues().get(1).getPosition(4,3));
        assertTrue(acTargetCell.getAllValues().get(1).getPosition(3,4));
        assertTrue(acTargetCell.getAllValues().get(1).getPosition(2,4));
        assertTrue(acTargetCell.getAllValues().get(1).getPosition(2,3));
        assertTrue(acTargetCell.getAllValues().get(1).getPosition(3,2));
        assertTrue(acTargetCell.getAllValues().get(1).getPosition(4,2));
