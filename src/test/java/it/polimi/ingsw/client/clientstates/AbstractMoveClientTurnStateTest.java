...
class AbstractMoveClientTurnStateTest {
    AbstractClientTurnStateTestHarness testHarness = new AbstractClientTurnStateTestHarness();

    private class ClientTurnStateToTest extends AbstractMoveClientTurnState {
    ...
    void notifyUiInteraction() {
        ...
        clientTurnState.notifyUiInteraction();
        verify(testHarness.getConnection()).send(any(ClientMoveMessage.class));
    }
}