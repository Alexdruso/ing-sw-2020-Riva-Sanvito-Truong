...
public class ShowGamePassiveGUIClientState extends AbstractShowGamePassiveClientState implements GUIClientState {
    /**
     * Instantiates a new SHOW_GAME_PASSIVE ClientState.
     *
     * @param client the client
     */
    public ShowGamePassiveGUIClientState(Client client) {
        super(client);
    }
