 ...
 */
public class BidirectionalLinkedHashMap<K, V> implements BidirectionalMap<K, V>{

    private LinkedHashMap<K, V> forwardMap = new LinkedHashMap<>();
    private LinkedHashMap<V, K> backwardMap = new LinkedHashMap<>();
