 ...
 * Each god is a class that contains all the information regarding the god itself, like as if it would be a physycal card.
 ...
 * </pre>
 *
 * @see it.polimi.ingsw.model.gods.God
 * @see it.polimi.ingsw.model.gods.GodCard
 */
